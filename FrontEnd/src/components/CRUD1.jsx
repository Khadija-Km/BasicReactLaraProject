            ...
            <form onSubmit={createHistorique}>
                ...
                <div className="mb-4">
                    ...
                    >
                        ...
                        <option value="Division de la gestion des ressources haumaine">Division de la gestion des
                            ressources haumaine
                        </option>
                        <option value="Division de la gestion des ressources haumaines">Division de la gestion des
                            ressources haumaines
                        </option>
                        <option value="Division des affaires administratives et financières">Division des affaires
                        ...
                        <option value="Centre régional d'orientation et scolaire professionnelle">Centre régional
                            d'orientation et scolaire professionnelle
                        </option>
                        <option value="Service des affaires juridiques et des partenariats">Service des affaires
                            juridiques et des partenariats
                        </option>
                        <option value="Service de la communication et du suivi">Service de la communication et du
                            suivi
                        </option>
                ...
                <div className="mb-4">
                    ...
                    <select
                        ...
                        {villes?.map((ville, key) => (
                            <option key={key} value={ville?.id}>{ville?.NomVille + "_________" } <span style={{color : 'red'}}>{ville?.Region }</span></option>
                        ))}
                    </select>
                </div>
